<template>
    <div class="Nuevo">
        ...
        <select name="txtestatus" id="txtstatus" v-model="estatusSeleccionado">
...
export default {
    ...
    methods: {
        nuevo: async function () {
            try {
                if (!this.alumnos.NCONTROL || !this.alumnos.NOMBRE || !this.CARRERA || !this.estatusSeleccionado) {
                    Swal.fire({
                        icon: "error",
                        title: "ADVERTENCIA",
