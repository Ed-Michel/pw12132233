<template>
  <div id="app">
    <nav>
      ...
      <router-link to="/cargarGrupo">Toma de Carga</router-link>
    </nav>
    <router-view/>
    <footer>
      <span class="letra-grande-titulo nito">Sistema de carga escolar CiberSaoko</span>
    </footer>
  </div>
</template>
